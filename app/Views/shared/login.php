...
<div class="max-w-md mx-auto bg-slate-900 border border-slate-800 rounded-xl p-8">
    ...
    <form method="POST" action="/login" class="space-y-4">
        ...
        <button type="submit" class="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-semibold py-2 rounded">Log in</button>
    </form>
</div>
HTML;

echo layout('Log in', $content, 'shared');
